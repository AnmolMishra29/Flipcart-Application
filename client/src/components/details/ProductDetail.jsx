...
const ProductDetail = ({ product }) => {
    ...
    const date = new Date(new Date().getTime()+( 5 * 60 * 60 * 24 * 1000 ));
       ...
       <>
          <Typography>{product.title.longTitle}</Typography>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge />No Cost EMI on Bajaj Finserv EMI Card on cartvalue above ₹2999 T&C</Typography>
            </SmallText>
            ...
            <Table>
                 <TableBody>
                       ...
                       <ColumnText>
                           <TableCell colSpan={2}>
                           <img src={addURL} style={{ width: 390}} alt="flipcartcoins"/>
                           </TableCell>
                       </ColumnText>
                       <ColumnText>
